...
export class DoctorService {
  ...
  pickExamination(id:number): Observable<any[]>{
  ...
  getPublicExamination(page: number): Observable<any[]>{
  ...
  getListDiagnosis(page):Observable<any[]>{
    return this.http.get<any[]>(`${this.API}/api/diagnosis/?page=${page}`, httpOptions);
  }
