...
export class StaffService {
  ...
  updateExamination(id : number, id_doctor: number, note : string):Observable<any>{
    const json = JSON.stringify({
      docter : id_doctor,
      note : note
    });
    return this.http.patch<any>(`${this.API}/api/staff/examination/${id}/`,json ,httpOptions)
  }

  deleteExamination(id : number):Observable<any>{
    return this.http.delete<any>(`${this.API}/api/examination/${id}/`, httpOptions)
  }
  ...
  getDiagnosisByExam(id:number):Observable<any[]>{
    return this.http.get<any[]>(`${this.API}/api/public/diagnosis/?examination=${id}`, httpOptions)
  }
  ...
  RejectScheduleRegistration(id: number):Observable<any>{
  ...
  getQueueList(): Observable<any[]> {
    return this.http.get<any[]>(`${this.API}/api/public/queue/`,httpOptions);
  }
}
